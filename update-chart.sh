...
CHART_DIR="$(pwd)/gpu-operator-charts"  # Use absolute path
...
# Debug: Print current working directory and CHART_DIR
...
# Debug: Check if the index.yaml includes the latest version
